  ...
  { 
    ...
    if(mavlink_parse_char(MAVLINK_COMM_0, c, &msg, &status)) 
    {
      ...
      case MAVLINK_MSG_ID_GLOBAL_POSITION_INT:   // 24
        ...
        //if(ap_fixtype == 3)  {
          ap_latitude = mavlink_msg_global_position_int_get_lat(&msg);
          ap_longitude = mavlink_msg_global_position_int_get_lon(&msg);
          ap_gps_altitude = mavlink_msg_global_position_int_get_relative_alt(&msg);    // 1m =1000
          //aq_gps_speed = mavlink_msg_gps_raw_int_get_vel(&msg);         // 100 = 1m/s
          ap_heading = mavlink_msg_global_position_int_get_hdg(&msg);
        //}
        //else
        //{
        //  ap_gps_speed = 0;  
