...
#define MIN_DISTANCE_TO_HOLD 250.0

#define MAX_POSITION_HOLD_CRAFT_ANGLE_CORRECTION 200.0 //300.0
#define POSITION_HOLD_SPEED 200.0 //300.0  
#define MAX_NAVIGATION_ANGLE_CORRECTION 200.0 //300.0
#define NAVIGATION_SPEED 200.0 //600.0 
...
void processPositionHold() {
  ...
  // only set correction angles if we're not in the min distance to hold perimeter
