...
#define MAX_POSITION_HOLD_CRAFT_ANGLE_CORRECTION 50.0
...
void computeCurrentSpeedInCmPerSec() {
  ...
  if(currentPosition.longitude == previousPosition.longitude && currentPosition.latitude == previousPosition.latitude) {
    ...
    distanceToPreviousX = (float)(currentPosition.longitude - previousPosition.longitude) * cosLatitude * 1.113195;
    distanceToPreviousY = (float)(currentPosition.latitude - previousPosition.latitude) * 1.113195;
...
//  LOG.print(",");
  //LOG.print(distanceToDestination2);
  //LOG.print(",");
